...
namespace BaldLion
{
	...
	{	
		...
		{		
			EventManager::UnregisterEventHandler("WindowResizedEvent", BL_BIND_OBJECT_FUNCTION(BaldLionGameLayer::OnWindowResizedEvent));
			EventManager::UnregisterEventHandler("KeyPressedEvent", BL_BIND_OBJECT_FUNCTION(BaldLionGameLayer::OnKeyPressedEvent));
		}
