	...
	namespace Editor {
		...
		public:
			...
			static void OnImGuiRender(ECS::ECSComponent* component, SceneHierarchyPanel* sceneHierarchyPanel) {
				...
				ComponentInspector::BeginComponentRender("Locomotion Component", component->GetComponentType(), sceneHierarchyPanel, (GImGui->Font->FontSize + GImGui->Style.FramePadding.y * 2.0f) * 3.0f);
