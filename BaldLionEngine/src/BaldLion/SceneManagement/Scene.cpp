		...
		void Scene::Init()
		{
			if (m_ecsManager == nullptr)
			{
				...
				{//Systems
					...
					BL_GENERATE_SYSTEM("ECS NavigationSystem", ECS::ECSNavigationSystem, m_ecsManager, ECS::ECSComponentType::Locomotion, ECS::ECSComponentType::NavMeshAgent, ECS::ECSComponentType::Transform);
					BL_GENERATE_SYSTEM("ECS PlayerControllerSystem", ECS::ECSPlayerControllerSystem, m_ecsManager, ECS::ECSComponentType::Locomotion, ECS::ECSComponentType::Transform);
