...
namespace BaldLion
{
	namespace Rendering
	{
		Framebuffer* Framebuffer::Create(const FramebufferSpecification& specs)
		{
			...
			case RendererPlatformInterface::RendererPlatform::OpenGL:		return MemoryManager::New<OpenGLFramebuffer>(STRING_TO_ID("Frame buffer"), AllocationType::FreeList_Renderer, specs);
			}
