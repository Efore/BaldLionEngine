...
namespace BaldLion
{
	namespace Rendering
	{
		...
		public:
			static Ref<Material> Create(const std::string& shaderPath, const glm::vec3& ambientColor, const glm::vec3& emissiveColor, const glm::vec3& diffuseColor, const glm::vec3& specularColor, float shininess,
