...
namespace BaldLion
{
	namespace Animation
	{
		...
		private:
			...
			static void SerializeAnimation(YAML::Emitter &out, const AnimationClip* animation);
			static AnimationClip* DeserializeAnimation(const YAML::detail::iterator_value& yamlEntity);
