...
namespace BaldLion
{
	...
	Ref<BaldLion::Shader> ShaderLibrary::Load(const std::string& filepath)
	{
	...
	Ref<BaldLion::Shader> ShaderLibrary::Load(const std::string& name, const std::string& filepath)
	{
		auto shader = Shader::Create(filepath);
		Add(name, shader);
		return shader;
	...
	Ref<BaldLion::Shader> ShaderLibrary::Get(const std::string& name)
	{
