...
namespace BaldLion
{
	...
	void WindowsWindow::Init(const WindowProps & props)
	{
		...
		BL_LOG_CORE_INFO("Creating window {0} ({1}, {2})", STRINGID_TO_STR_C(props.Title), props.Width, props.Height);
		...
		m_window = glfwCreateWindow((int)props.Width, (int)props.Height, STRINGID_TO_STR_C(props.Title), nullptr, nullptr);
